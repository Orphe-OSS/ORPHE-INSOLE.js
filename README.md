...
<!doctype html>
  <html lang="en">
    ...
    <body>
      ...
      <p id="sensor-data"></p>
      <script src="https://cdn.jsdelivr.net/gh/Orphe-OSS/ORPHE-INSOLE.js@v1.3.3/dist/orphe-insole.min.js"></script>
      <script>
...
```html
<script src="https://cdn.jsdelivr.net/gh/Orphe-OSS/ORPHE-INSOLE.js@v1.3.3/src/InsoleSimulator.js"></script>
<script>
