...
(function () {
    const translations = {
        ja: {
            ...
            connectTitle: 'つないでみる',
            connectStep1: 'INSOLE の電源を入れる（充電済みであることを確認）',
...
&lt;/script&gt;`,
            ...
            pressureDesc: '足裏の6点で荷重を計測します。足型マップでは値が大きいほど赤く表示され、<span class="cop-legend"></span> は6点の重み付き平均から計算した<strong>圧力中心（CoP）</strong>です。左右2台を接続すると、体重移動・左右バランスがそのまま観察できます。',
...
insole.gotEuler = function (euler) {
  // {pitch, roll, yaw} 単位: rad
        ...
        en: {
            ...
            connectStep1: 'Turn on the INSOLE and confirm it is charged.',
...
&lt;/script&gt;`,
            ...
            pressureDesc: 'Six points under each foot measure load. On the foot map, larger values appear redder, and <span class="cop-legend"></span> indicates the <strong>center of pressure (CoP)</strong> calculated from a weighted average of the six points. With two devices connected, you can observe weight shift and left/right balance directly.',
