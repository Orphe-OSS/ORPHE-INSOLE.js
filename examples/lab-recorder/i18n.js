(function attachLabRecorderI18n(root, factory) {
  ...
  const translations = {
    ja: {
      ...
      markerLabelPlaceholder: "ラベル（任意）例: mocap start / stomp",
      markerColIndex: "#",
      ...
      m_clock_spread: "offset spread", m_clock_spread_note: "新しいデータを運んだ FIFO バッチ間の offset の最大−最小 [ms]（再送だけのバッチは除外）。回収ジッタ＝host_time_est の誤差上界の目安",
    ...
    en: {
      ...
      markerLabelPlaceholder: "Label (optional), e.g. mocap start / stomp",
      markerColIndex: "#",
      markerColLabel: "label",
      markerColHost: "host time",
      markerColElapsed: "elapsed",
      ...
      m_clock_spread: "offset spread", m_clock_spread_note: "max − min of the offset across FIFO batches that carried new data [ms] (re-request-only batches excluded); retrieval jitter, an upper bound on the host_time_est error",
